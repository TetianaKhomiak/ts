const App = () => {
  ...
  const scienceArea = new Area("Science");
  const school = new School();
  school.addArea(mathArea);
  school.addArea(scienceArea);
  const algebraGroupA = new Group("Algebra Group A", "Algebra", mathArea);
  const biologyGroupB = new Group("Biology Group B", "Biology", scienceArea);
  const algebraLevel = new Level("Algebra", "Introduction");
  const biologyLevel = new Level("Biology", "Introduction");

  algebraLevel.addGroup(algebraGroupA);
  biologyLevel.addGroup(biologyGroupB);
  console.log(school.areas);
  console.log(algebraLevel.groups);
  return <div>App</div>;
};
